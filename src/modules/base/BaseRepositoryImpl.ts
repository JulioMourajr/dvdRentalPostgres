import { Repository, EntityTarget, FindOptionsWhere, DeepPartial, ObjectLiteral } from 'typeorm';
...
export class BaseRepositoryImpl<T extends ObjectLiteral, U, V> implements BaseRepository<T, U, V> {
